            ...
            <form onSubmit={handlePayment} className="space-y-8">
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        placeholder="John"
                        className="h-12 glass bg-foreground/5 dark:bg-white/5 border-border dark:border-white/10"
                        required
                      />
                    </div>
                    <div className="space-y-2">
              ...
              <div className="glass-card p-8 text-center space-y-4">
                ...
                <p className="text-muted-foreground max-w-md mx-auto">
                  You will be redirected to Stripe's secure payment gateway to
                  complete your transaction. No payment information is stored on
                  our servers.
                </p>
              </div>
              ...
              <div className="flex items-center gap-4 text-sm text-muted-foreground p-4 bg-primary/10 rounded-xl border border-primary/20">
                ...
                <p>
                  SparkLift uses industry-standard encryption to protect your
