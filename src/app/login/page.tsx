    ...
    <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          <Link
            href="/"
            className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-tr from-primary to-accent text-white mb-6 shadow-lg shadow-primary/20"
          >
            <svg
              width="24"
              height="24"
          ...
          <p className="text-muted-foreground">
            Log in to your SparkLift account
          </p>
        </div>
        ...
        <div className="glass-card p-8 rounded-3xl mb-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 text-md shadow-[0_0_20px_rgba(var(--primary),0.3)]"
            >
