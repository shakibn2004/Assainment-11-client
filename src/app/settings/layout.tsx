...
export default function SettingsLayout({ children }: { children: ReactNode }) {
  ...
  if (!user)
    return <div className="min-h-screen pt-24 text-center">Please log in.</div>;
    ...
    <div className="min-h-screen bg-background pt-24 pb-12">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="flex items-center gap-4 mb-8">
          <Link
            href="/dashboard"
            className="p-2 rounded-full hover:bg-foreground/5 text-muted-foreground hover:text-foreground transition-colors group"
          >
